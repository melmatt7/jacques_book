import { CovalentApiResponse, ItemsEntity } from '../../constants/api/covalent/ResponseTypes';
import { client } from './Client';

export const getAddressTransactions = async (address: string): Promise<ItemsEntity[]> => {
  try {
